...
在项目的根包下创建`security.LoginPrincipal`作为自定义的当事人类型：

![image-20230524180309023](assets/image-20230524180309023.png)

并且，在解析JWT成功后，使用此类型作为当事人来创建认证信息：

![image-20230524180356557](assets/image-20230524180356557.png)

后续，在Controller中，就可以通过`@AuthenticationPrincipal`来注入自定义的当事人数据，例如：

![image-20230524180449469](assets/image-20230524180449469.png)
